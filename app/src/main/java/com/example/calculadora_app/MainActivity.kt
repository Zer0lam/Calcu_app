...
class MainActivity : AppCompatActivity() {
    ...
    private fun setButtonClickListeners() {
        ...
        val operationButtons = listOf<Button>(
            findViewById(R.id.btnmas), findViewById(R.id.btnres),
            findViewById(R.id.btnentre), findViewById(R.id.btnmul),
            findViewById(R.id.btnraiz), findViewById(R.id.btnx2),
            findViewById(R.id.btnx3), findViewById(R.id.btnsin),
            findViewById(R.id.btncos), findViewById(R.id.btntan),
            findViewById(R.id.btnlog), findViewById(R.id.btnln),
            findViewById(R.id.btnparent), findViewById(R.id.btnparent2),
    ...
    private fun evaluateExpression() {
        val expression = tvDos.text.toString().replace('÷', '/').replace('x', '*').replace("π", PI.toString())
        ...
        return object {
            ...
            private fun parseFactor(expression: String): Double {
                ...
                if (eat(expression, '('.toInt())) {
                    ...
                    nextChar(expression) // Consume the '√' character
                    X = sqrt(parseFactor(expression))
                } else if (ch == 'π'.toInt()) {
                    nextChar(expression) // Consume the 'π' character
                    X = PI
